...
Accel_vector::Accel_vector(int16_t Accel_x,int16_t Accel_y,int16_t Accel_z,int16_t Accel_a,uint64_t epoch_start,uint64_t epoch_stop)//,uint32_t epoch_stop
			:
